...
func (ths *Reader) rdOrders() bool {
	...
	// _L.Trace("addr = %s", addr)
	// _L.Trace("param = %s", ths.orderParams)
	ret, err := ths.orderClt.ClientPostForm(addr, rhttp.ReturnCustomType, ths.orderParams)
